...
//        NodeList users_axis = head.getElementsByTagName("prefix:username");
//        NodeList passwords_axis = head.getElementsByTagName("prefix:password");
//        if (users_axis.getLength() < 1) {
//            throw new Fault(new IllegalArgumentException("找不到用户信息"));
//        }
//        if (users_axis.getLength() < 1) {
//            throw new Fault(new IllegalArgumentException("找不到密码信息"));
//        }
//        String userName = users_axis.item(0).getTextContent().trim();
//        String password = passwords_axis.item(0).getTextContent().trim();
